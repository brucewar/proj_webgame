function Connects(_id, _gameName, _ownerID, _createDate, _pictureIDs, _iconID, _public, _playedTimes, _topScore, _topScorePlayer, _lastPlayers, _fullImageBlobId, _thumbnailId, _status) {
  this.id = _id;
