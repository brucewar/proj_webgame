(function () {
  ...
  var c = {
    ...
    //engineDir:'../../public_js/cocos2d/cocos2d/',
  ...
  window.addEventListener('DOMContentLoaded', function () {
    ...
    if (c.SingleEngineFile && !c.engineDir) {
      ...
      alert('You must specify either the single engine file OR the engine directory in "stone_cocos2d.js"');
    }
    /*********Delete this section if you have packed all files into one*******/
    ...
    document.ccConfig = c;
    s.id = 'Googdood Game - Stone - Author Bruce';
